...
public class BaiduLocationTool {
    ...
    public static BaiduLocationTool newInstance(Activity activity) {
         BaiduLocationTool baiduLocationTool = new BaiduLocationTool(activity);
        return baiduLocationTool;
    }

    private BaiduLocationTool(Activity activity) {
    ...
    private void targetSDK(){
        if (Build.VERSION.SDK_INT >= 23) {
         String ss = Manifest.permission.READ_PHONE_STATE;
