...
public class ViewHolder {
    ...
    public void setImage(int resId, int placeholder, String path) {
        ImageView imgView = getSubView(resId);
        GlideUtils.concerImg(imgView,placeholder,path);
    }
    ...
    public void invisible(int resId) {
        View view = getSubView(resId);
        if (view != null) {
    ...
    public void setCircleImage(int resId,String imgUrl) {
        ImageView imgView = getSubView(resId);
        GlideUtils.circleImg(imgView,imgUrl);
    }
    public void setCircleImage(int resId,int imgUrl) {
        ImageView imgView = getSubView(resId);
        GlideUtils.circleImg(imgView,imgUrl);
    }
    ...
    public void setCircleImage(int resId, int defaultImg, String imgUrl) {
        ImageView imgView = getSubView(resId);
        GlideUtils.circleImg(imgView,defaultImg,imgUrl);
    }
