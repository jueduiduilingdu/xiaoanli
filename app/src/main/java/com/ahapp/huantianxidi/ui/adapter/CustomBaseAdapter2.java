...
public abstract class CustomBaseAdapter2<T> extends BaseAdapter {

    private List<T> mData;
    private int mLayoutRes;           //布局id

    public CustomBaseAdapter2(List<T> mData, int mLayoutRes) {
        this.mData = mData;
        this.mLayoutRes = mLayoutRes;
    }

    public void updateAdapterList(List<T> mData) {
        this.mData = mData;
