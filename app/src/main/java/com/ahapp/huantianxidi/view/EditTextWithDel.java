...
//        imgAble = mContext.getResources().getDrawable(R.mipmap.icon_search_grey);
        imgInable = ContextCompat.getDrawable(mContext, R.mipmap.icon_close);
        imgAble = ContextCompat.getDrawable(mContext, R.mipmap.icon_search);
