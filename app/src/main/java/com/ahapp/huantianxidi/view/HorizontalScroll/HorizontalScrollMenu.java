package com.ahapp.huantianxidi.view.HorizontalScroll;
...
//		vp_content = (MyViewPager) v.findViewById(R.id.vp_content);
     ...
     * @param adapter
     */
    private void initView(HorizontalScrollBaseAdapter adapter) {
        if (null == adapter) {
            return;
        }
     ...
     * @param adapter
     */
    public void notifyDataSetChanged(HorizontalScrollBaseAdapter adapter) {
