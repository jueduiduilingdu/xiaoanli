...
public class ClearEditText extends EditText implements View.OnFocusChangeListener,
    ...
    private void init() {
        ...
        if (mClearDrawable == null) {
            mClearDrawable = getResources().getDrawable(R.mipmap.icon_grey_delete);
        }
    ...
    public void onTextChanged(CharSequence s, int start, int count, int after) {
        if (hasFoucs) {
            ...
            if (mTextChangedListener!=null){
                mTextChangedListener.onChanged();
            }
        }
    ...
    public void setTextChangedListener(OnTextChangedListener mTextChangedListener) {
